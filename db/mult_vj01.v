...
module  mult_vj01
	...
	assign
		wire_sft10a_in = {w217w, {w217w, {w217w, {w217w, {w217w, {w_lone_sum_node11w[6], {w_lone_sum_node11w[5], {w_lone_sum_node11w[4], {w_lone_sum_node11w[3], {w_lone_sum_node11w[2], {w_lone_sum_node11w[1], {w_lone_sum_node11w[0], {2{w217w}}}}}}}}}}}}}};
	soft   sft11a_0
	( 
	...
	assign
		wire_sft3a_in = {w217w, {w217w, {w_sum_node10w[59], {w_sum_node10w[58], {w_lone_sum_node11w[10], {w_lone_sum_node11w[9], {w_sum_node10w[29], {w_sum_node10w[28], {w_sum_node10w[14], {w_sum_node10w[13], {w_sum_node10w[12], {w_sum_node10w[11], {w_sum_node10w[10], {w_sum_node10w[9], {w_sum_node10w[8], {w_sum_node10w[7], {w_sum_node10w[6], {w_sum_node10w[5], {w_sum_node10w[4], {w_sum_node10w[3:2]}}}}}}}}}}}}}}}}}}}};
	soft   sft4a_0
	( 
	...
	assign
		wire_sft5a_in = {w217w, {w217w, {w217w, {wire_sft11a_out[13], {wire_sft11a_out[12], {wire_sft11a_out[11], {wire_sft11a_out[10], {wire_sft11a_out[9], {wire_sft11a_out[8], {wire_sft11a_out[7], {wire_sft11a_out[6], {wire_sft11a_out[5], {wire_sft11a_out[4], {wire_sft11a_out[3], {wire_sft11a_out[2], {wire_sft11a_out[1], {wire_sft11a_out[0], {w_sum_node10w[31], {w_sum_node10w[30], {2{w217w}}}}}}}}}}}}}}}}}}}}};
	soft   sft6a_0
	( 
	...
	assign
		wire_sft8a_in = {w217w, {w_sum_node10w[44], {w_sum_node10w[43], {w_lone_sum_node11w[8], {w_lone_sum_node11w[7], {w_sum_node10w[53], {w_sum_node10w[52], {w_sum_node10w[51], {w_sum_node10w[50], {w_sum_node10w[49], {w_sum_node10w[48], {w_sum_node10w[47], {w_sum_node10w[46:45]}}}}}}}}}}}}};
	soft   sft9a_0
	( 
	...
	assign
		wire_sft9a_in = {w217w, {w217w, {w217w, {w_sum_node10w[55], {w_sum_node10w[54], {w_sum_node10w[40], {w_sum_node10w[39], {w_sum_node10w[38], {w_sum_node10w[37], {w_sum_node10w[36], {w_sum_node10w[35], {w_sum_node10w[34], {w_sum_node10w[33:32]}}}}}}}}}}}}};
	assign
		dataa_node = {datab[12:0]},
		datab_node = {dataa[8:0]},
		final_result_node = {w358w[21:0]},
		result = {final_result_node[21:0]},
		w217w = 1'b0,
		w358w = {wire_sft6a_out[20:19], wire_sft6a_out[18:17], wire_sft6a_out[16:15], wire_sft6a_out[14:13], wire_sft6a_out[12:11], wire_sft6a_out[10:9], wire_sft6a_out[8:7], wire_sft6a_out[6:5], wire_sft6a_out[4:3], wire_sft6a_out[2:1], wire_sft6a_out[0], w_sum_node10w[1], w_sum_node10w[0]},
		w_decoder_node9w = {({dataa_node[12:0]} & {13{w_le_datab_node8w[8]}}), ({dataa_node[12:0]} & {13{w_le_datab_node8w[7]}}), ({dataa_node[12:0]} & {13{w_le_datab_node8w[6]}}), ({dataa_node[12:0]} & {13{w_le_datab_node8w[5]}}), ({dataa_node[12:0]} & {13{w_le_datab_node8w[4]}}), ({dataa_node[12:0]} & {13{w_le_datab_node8w[3]}}), ({dataa_node[12:0]} & {13{w_le_datab_node8w[2]}}), ({dataa_node[12:0]} & {13{w_le_datab_node8w[1]}}), ({dataa_node[12:0]} & {13{w_le_datab_node8w[0]}})},
		w_le_datab_node8w = {datab_node[8:0]},
		w_lone_sum_node11w = {w_decoder_node9w[116:104]},
