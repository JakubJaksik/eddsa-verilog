//lpm_mult CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEDICATED_MULTIPLIER_CIRCUITRY="NO" DEVICE_FAMILY="Cyclone V" DSP_BLOCK_BALANCING="Auto" INPUT_A_IS_CONSTANT="NO" INPUT_B_IS_CONSTANT="NO" LPM_REPRESENTATION="UNSIGNED" LPM_WIDTHA=13 LPM_WIDTHB=13 LPM_WIDTHP=26 LPM_WIDTHS=1 MAXIMIZE_SPEED=6 dataa datab result CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48
...
//VERSION_BEGIN 21.1 cbx_cycloneii 2022:06:23:22:03:45:SJ cbx_lpm_add_sub 2022:06:23:22:03:45:SJ cbx_mgl 2022:06:23:22:04:21:SJ cbx_nadder 2022:06:23:22:03:45:SJ cbx_stratix 2022:06:23:22:03:45:SJ cbx_stratixii 2022:06:23:22:03:45:SJ  VERSION_END
...
module  mult_fl01
	...
	wire	[13:0]	wire_sum_adder1aa_5dataa;
	wire	[13:0]	wire_sum_adder1aa_5datab;
	wire	[13:0]	wire_sum_adder1aa_5result;
	...
	assign
		wire_sum_adder1aa_4dataa = {1'b0, w_decoder_node9w[129:117]},
		wire_sum_adder1aa_4datab = {{2{1'b0}}, w_decoder_node9w[116:105]};
	assign
		wire_sum_adder1aa_5result = wire_sum_adder1aa_5dataa + wire_sum_adder1aa_5datab;
	assign
		wire_sum_adder1aa_5dataa = {1'b0, w_decoder_node9w[155:143]},
		wire_sum_adder1aa_5datab = {{2{1'b0}}, w_decoder_node9w[142:131]};
	soft   sft10a_0
	( 
	...
	assign
		wire_sft10a_in = {w307w, {w307w, {w307w, {w307w, {w_sum_node10w[58], {w_lone_sum_node11w[6], {w_lone_sum_node11w[5], {w_sum_node10w[81], {w_sum_node10w[80], {w_sum_node10w[66], {w_sum_node10w[65], {w_sum_node10w[64], {w_sum_node10w[63], {w_sum_node10w[62], {w_sum_node10w[61], {w_sum_node10w[60], {2{w307w}}}}}}}}}}}}}}}}}};
	soft   sft11a_0
	( 
	...
	assign
		wire_sft13a_in = {w307w, {w_sum_node10w[44], {w_sum_node10w[43], {w_lone_sum_node11w[4], {w_lone_sum_node11w[3], {w_sum_node10w[79], {w_sum_node10w[78], {w_sum_node10w[77], {w_sum_node10w[76:75]}}}}}}}}};
	soft   sft14a_0
	( 
	...
	assign
		wire_sft14a_in = {w307w, {w307w, {w307w, {w_sum_node10w[42], {w_sum_node10w[41], {w_sum_node10w[27], {w_sum_node10w[26], {w_sum_node10w[25], {w_sum_node10w[24:23]}}}}}}}}};
	soft   sft15a_0
	( 
	...
	assign
		wire_sft15a_in = {w307w, {w307w, {w307w, {w307w, {w307w, {w_lone_sum_node11w[2], {w_lone_sum_node11w[1], {w_lone_sum_node11w[0], {2{w307w}}}}}}}}}};
	soft   sft16a_0
	( 
	...
	assign
		wire_sft3a_in = {w307w, {w307w, {w_sum_node10w[89], {w_sum_node10w[88], {w_lone_sum_node11w[10], {w_lone_sum_node11w[9], {w_sum_node10w[59], {w_sum_node10w[71], {w_sum_node10w[57], {w_sum_node10w[56], {w_sum_node10w[29], {w_sum_node10w[28], {w_sum_node10w[14], {w_sum_node10w[13], {w_sum_node10w[12], {w_sum_node10w[11], {w_sum_node10w[10], {w_sum_node10w[9], {w_sum_node10w[8], {w_sum_node10w[7], {w_sum_node10w[6], {w_sum_node10w[5], {w_sum_node10w[4], {w_sum_node10w[3:2]}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft4a_0
	( 
	...
	assign
		wire_sft4a_in = {w307w, {w307w, {w_lone_sum_node11w[12], {w_lone_sum_node11w[11], {w_sum_node10w[87], {w_sum_node10w[86], {w_sum_node10w[72], {wire_sft11a_out[13], {wire_sft11a_out[12], {wire_sft11a_out[11], {wire_sft11a_out[10], {wire_sft11a_out[9], {wire_sft11a_out[8], {wire_sft11a_out[7], {wire_sft11a_out[6], {wire_sft11a_out[5], {wire_sft11a_out[4], {w_sum_node10w[22], {w_sum_node10w[21], {w_sum_node10w[20], {w_sum_node10w[19], {w_sum_node10w[18], {w_sum_node10w[17], {w_sum_node10w[16:15]}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft5a_0
	( 
	...
	assign
		wire_sft8a_in = {w307w, {w_sum_node10w[74], {w_sum_node10w[73], {w_lone_sum_node11w[8], {w_lone_sum_node11w[7], {w_sum_node10w[83], {w_sum_node10w[82], {w_sum_node10w[68], {w_sum_node10w[67], {w_sum_node10w[53], {w_sum_node10w[52], {w_sum_node10w[51], {w_sum_node10w[50], {w_sum_node10w[49], {w_sum_node10w[48], {w_sum_node10w[47], {w_sum_node10w[46:45]}}}}}}}}}}}}}}}}};
	soft   sft9a_0
	( 
	...
	assign
		wire_sft9a_in = {w307w, {w307w, {w307w, {w_sum_node10w[85], {w_sum_node10w[84], {w_sum_node10w[70], {w_sum_node10w[69], {w_sum_node10w[55], {w_sum_node10w[54], {w_sum_node10w[40], {w_sum_node10w[39], {w_sum_node10w[38], {w_sum_node10w[37], {w_sum_node10w[36], {w_sum_node10w[35], {w_sum_node10w[34], {w_sum_node10w[33:32]}}}}}}}}}}}}}}}}};
	assign
		dataa_node = {dataa[12:0]},
		datab_node = {datab[12:0]},
		final_result_node = {w519w[25:0]},
		result = {final_result_node[25:0]},
		w307w = 1'b0,
		w519w = {wire_sft6a_out[24:23], wire_sft6a_out[22:21], wire_sft6a_out[20:19], wire_sft6a_out[18:17], wire_sft6a_out[16:15], wire_sft6a_out[14:13], wire_sft6a_out[12:11], wire_sft6a_out[10:9], wire_sft6a_out[8:7], wire_sft6a_out[6:5], wire_sft6a_out[4:3], wire_sft6a_out[2:1], wire_sft6a_out[0], w_sum_node10w[1], w_sum_node10w[0]},
		w_decoder_node9w = {({dataa_node[12:0]} & {13{w_le_datab_node8w[12]}}), ({dataa_node[12:0]} & {13{w_le_datab_node8w[11]}}), ({dataa_node[12:0]} & {13{w_le_datab_node8w[10]}}), ({dataa_node[12:0]} & {13{w_le_datab_node8w[9]}}), ({dataa_node[12:0]} & {13{w_le_datab_node8w[8]}}), ({dataa_node[12:0]} & {13{w_le_datab_node8w[7]}}), ({dataa_node[12:0]} & {13{w_le_datab_node8w[6]}}), ({dataa_node[12:0]} & {13{w_le_datab_node8w[5]}}), ({dataa_node[12:0]} & {13{w_le_datab_node8w[4]}}), ({dataa_node[12:0]} & {13{w_le_datab_node8w[3]}}), ({dataa_node[12:0]} & {13{w_le_datab_node8w[2]}}), ({dataa_node[12:0]} & {13{w_le_datab_node8w[1]}}), ({dataa_node[12:0]} & {13{w_le_datab_node8w[0]}})},
		w_le_datab_node8w = {datab_node[12:0]},
		w_lone_sum_node11w = {w_decoder_node9w[168:156]},
		w_sum_node10w = {wire_sum_adder1aa_5result[13:0], w_decoder_node9w[130], wire_sum_adder1aa_4result[13:0], w_decoder_node9w[104], wire_sum_adder1aa_3result[13:0], w_decoder_node9w[78], wire_sum_adder1aa_2result[13:0], w_decoder_node9w[52], wire_sum_adder1aa_1result[13:0], w_decoder_node9w[26], wire_sum_adder1aa_0result[13:0], w_decoder_node9w[0]};
endmodule //mult_fl01
//VALID FILE
