//lpm_mult CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEDICATED_MULTIPLIER_CIRCUITRY="NO" DEVICE_FAMILY="Cyclone V" DSP_BLOCK_BALANCING="Auto" INPUT_A_IS_CONSTANT="NO" INPUT_B_IS_CONSTANT="NO" LPM_REPRESENTATION="UNSIGNED" LPM_WIDTHA=13 LPM_WIDTHB=18 LPM_WIDTHP=31 LPM_WIDTHS=1 MAXIMIZE_SPEED=5 dataa datab result CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48
...
module  mult_el01
	...
	assign
		wire_sft10a_in = {w357w, {w357w, {w357w, {w357w, {w_sum_node10w[78], {w_lone_sum_node11w[11], {w_lone_sum_node11w[10], {w_sum_node10w[111], {w_sum_node10w[110], {w_sum_node10w[91], {w_sum_node10w[90], {w_sum_node10w[89], {w_sum_node10w[88], {w_sum_node10w[87], {w_sum_node10w[86], {w_sum_node10w[85], {w_sum_node10w[84], {w_sum_node10w[83], {w_sum_node10w[82], {w_sum_node10w[81], {w_sum_node10w[80], {2{w357w}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft11a_0
	( 
	...
	assign
		wire_sft13a_in = {w357w, {w_sum_node10w[59], {w_sum_node10w[58], {w_lone_sum_node11w[9], {w_lone_sum_node11w[8], {w_sum_node10w[109], {w_sum_node10w[108], {w_sum_node10w[107], {w_sum_node10w[106], {w_sum_node10w[105], {w_sum_node10w[104], {w_sum_node10w[103], {w_sum_node10w[102], {w_sum_node10w[101:100]}}}}}}}}}}}}}};
	soft   sft14a_0
	( 
	...
	assign
		wire_sft14a_in = {w357w, {w357w, {w357w, {w_sum_node10w[57], {w_sum_node10w[56], {w_sum_node10w[37], {w_sum_node10w[36], {w_sum_node10w[35], {w_sum_node10w[34], {w_sum_node10w[33], {w_sum_node10w[32], {w_sum_node10w[31], {w_sum_node10w[30], {w_sum_node10w[29:28]}}}}}}}}}}}}}};
	soft   sft15a_0
	( 
	...
	assign
		wire_sft15a_in = {w357w, {w357w, {w357w, {w357w, {w357w, {w_lone_sum_node11w[7], {w_lone_sum_node11w[6], {w_lone_sum_node11w[5], {w_lone_sum_node11w[4], {w_lone_sum_node11w[3], {w_lone_sum_node11w[2], {w_lone_sum_node11w[1], {w_lone_sum_node11w[0], {2{w357w}}}}}}}}}}}}}}};
	soft   sft16a_0
	( 
	...
	assign
		wire_sft9a_in = {w357w, {w357w, {w357w, {w_sum_node10w[115], {w_sum_node10w[114], {w_sum_node10w[95], {w_sum_node10w[94], {w_sum_node10w[75], {w_sum_node10w[74], {w_sum_node10w[55], {w_sum_node10w[54], {w_sum_node10w[53], {w_sum_node10w[52], {w_sum_node10w[51], {w_sum_node10w[50], {w_sum_node10w[49], {w_sum_node10w[48], {w_sum_node10w[47], {w_sum_node10w[46], {w_sum_node10w[45], {w_sum_node10w[44], {w_sum_node10w[43:42]}}}}}}}}}}}}}}}}}}}}}};
	assign
		dataa_node = {datab[17:0]},
		datab_node = {dataa[12:0]},
		final_result_node = {w629w[30:0]},
		result = {final_result_node[30:0]},
		w357w = 1'b0,
		w629w = {wire_sft6a_out[29:28], wire_sft6a_out[27:26], wire_sft6a_out[25:24], wire_sft6a_out[23:22], wire_sft6a_out[21:20], wire_sft6a_out[19:18], wire_sft6a_out[17:16], wire_sft6a_out[15:14], wire_sft6a_out[13:12], wire_sft6a_out[11:10], wire_sft6a_out[9:8], wire_sft6a_out[7:6], wire_sft6a_out[5:4], wire_sft6a_out[3:2], wire_sft6a_out[1:0], w_sum_node10w[1], w_sum_node10w[0]},
		w_decoder_node9w = {({dataa_node[17:0]} & {18{w_le_datab_node8w[12]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[11]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[10]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[9]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[8]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[7]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[6]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[5]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[4]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[3]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[2]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[1]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[0]}})},
		w_le_datab_node8w = {datab_node[12:0]},
		w_lone_sum_node11w = {w_decoder_node9w[233:216]},
		w_sum_node10w = {wire_sum_adder1aa_5result[18:0], w_decoder_node9w[180], wire_sum_adder1aa_4result[18:0], w_decoder_node9w[144], wire_sum_adder1aa_3result[18:0], w_decoder_node9w[108], wire_sum_adder1aa_2result[18:0], w_decoder_node9w[72], wire_sum_adder1aa_1result[18:0], w_decoder_node9w[36], wire_sum_adder1aa_0result[18:0], w_decoder_node9w[0]};
endmodule //mult_el01
//VALID FILE
